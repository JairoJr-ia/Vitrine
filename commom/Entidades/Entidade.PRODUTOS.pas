...
type
  ...
  private
    ...
    procedure SetUSU_ALT(const Value: Variant);
    ...
    procedure SetKIT(const Value: Variant);
    ...
    procedure SetCOD_CFOP(const Value: Variant);
    ...
    procedure SetPORC_DIF(const Value: Variant);
    ...
    procedure SetSEL(const Value: Variant);
    procedure SetCEST(const Value: String);
    procedure SetNOME_REDUZ(const Value: Variant);
  ...
  [Campo('USU_ALT')]
  property USU_ALT : Variant read FUSU_ALT write SetUSU_ALT;
  [Campo('DATA_ALT')]
  ...
  [Campo('KIT')]
  property KIT : Variant read FKIT write SetKIT;
  [Campo('GARANTIA')]
  ...
  [Campo('COD_CFOP')]
  property COD_CFOP : Variant read FCOD_CFOP write SetCOD_CFOP;
  [Campo('PORC_IPI')]
  ...
  [Campo('PORC_DIF')]
  property PORC_DIF : Variant read FPORC_DIF write SetPORC_DIF;
  [Campo('NCM')]
  ...
  [Campo('SEL')]
  property SEL : Variant read FSEL write SetSEL;
  [Campo('CEST')]
  property CEST : String read FCEST write SetCEST;
  [Campo('NOME_REDUZ')]
  property NOME_REDUZ : Variant read FNOME_REDUZ write SetNOME_REDUZ;
  [Campo('MVA')]
...
procedure TPRODUTOS.SetUSU_ALT(const Value: Variant);
begin
  FUSU_ALT := Value;
end;
...
procedure TPRODUTOS.SetKIT(const Value: Variant);
begin
  FKIT := Value;
end;
...
procedure TPRODUTOS.SetVALIDADE(const Value: Variant);
begin
  FVALIDADE := Value;
end;
...
procedure TPRODUTOS.SetCOD_CFOP(const Value: Variant);
begin
  FCOD_CFOP := Value;
end;
...
procedure TPRODUTOS.SetPORC_DIF(const Value: Variant);
begin
  FPORC_DIF := Value;
end;
...
procedure TPRODUTOS.SetCSOSN(const Value: String);
begin
  FCSOSN := Value;
end;
 
procedure TPRODUTOS.SetSEL(const Value: Variant);
begin
  FSEL := Value;
end;
...
procedure TPRODUTOS.SetNOME_REDUZ(const Value: Variant);
begin
  FNOME_REDUZ := Value;
end;
